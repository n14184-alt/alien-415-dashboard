...
<style>
    ...
    td { border-bottom: 1px solid #eee; padding: 10px; font-size: 15px; white-space: nowrap; }
    .warning-icon { color: #f4b400; font-weight: bold; margin-right: 4px; font-size: 16px; }
    .status-text { color: black; font-weight: bold; }
    .neg { color: #d0021b; font-weight: bold; } /* 效能變動紅字排壓 */
</style>
<table>
    ...
    <tr><td colspan="7" style="text-align:center; color:gray; padding:20px;">... 其餘 17 支實彈 Slope 監控中 ...</td></tr>
</table>
"""
